...
parser.add_argument('--input_image_dir', type=str, default='./input_images')
parser.add_argument('--batch_size', type=int, default=100)
parser.add_argument('--device', type=str, choices=["cuda:3", "cpu"], default="cuda:3")
